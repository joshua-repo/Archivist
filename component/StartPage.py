...
class StartPage(QWidget):
    ...
    def initUI(self):
        ...
        self.impLabelLogin = QLabel('Set up Archivist via login.(W.I.P)')
        ...
        grid = QGridLayout()
        self.setLayout(grid)
        grid.addWidget(self.welLabel, 0, 0)
        grid.addWidget(self.impLabelLocal, 1, 0)
        grid.addWidget(self.pathEdit, 2, 0)
        grid.addWidget(self.pathButtom, 2, 1)
        grid.addWidget(self.impLabelLogin, 3, 0)
        grid.addWidget(self.accountEdit, 4, 0)
        grid.addWidget(self.passwordEdit, 5, 0)
        grid.addWidget(self.loginButtom, 5, 1)
        grid.addWidget(self.registButtom, 5, 2)
        grid.addWidget(self.okButtom, 6, 5)
        grid.addWidget(self.exitButtom, 6, 6)
